  ...
  return (
    <div className="flex flex-wrap fixed w-full z-50">
      <section className="relative mx-auto w-full">
        ...
        <nav className="flex justify-between bg-gray-900 text-white w-full">
          <div className="px-5 xl:px-12 py-6 flex w-full items-center">
            ...
            <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
              ...
              <li><a className="hover:text-gray-200" href="#menu">Menu</a></li>
              <li><a className="hover:text-gray-200" href="#track-item">Track order</a></li>
              <li><a className="hover:text-gray-200" href="#footer">Contact Us</a></li>
            </ul>
          ...
          <div className="xl:hidden flex items-center pr-6">
            <button
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gray-900 text-white w-full px-6 py-4 space-y-2">
            <a className="block hover:text-gray-200" href="#">Home</a>
            <a className="block hover:text-gray-200" href="#">Category</a>
            <a className="block hover:text-gray-200" href="#">Collections</a>
            <a className="block hover:text-gray-200" href="#">Contact Us</a>
          </div>
        )}
      </section>
